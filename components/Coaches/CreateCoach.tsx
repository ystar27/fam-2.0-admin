...
export default function CreateCoach({ setCreateCoach }: any) {
        ...
        <div className={"p-5 py-10 bg-white"}>
          <div className={"flex flex-col"}>
            ...
            <div className={"mb-4"}>
              ...
              >
                <option className={"hover:bg-purple-400"}>Issue</option>
              </select>
            </div>
            <div className={"mb-4"}>
              <select
              ...
              >
                <option className={"hover:bg-purple-400"}>Coach Description (Optional)</option>
              </select>
            </div>
            <div className={"mb-4"}>
              <button
