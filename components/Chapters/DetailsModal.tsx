      ...
      >
        ...
        <div className={"p-5 py-10 bg-white"}>
          <div className="flex mb-4 items-center justify-between">
            <h4 className="text-primary text-lg font-medium max-w-max border-b border-primary mb-5">
              Details
            </h4>
          ...
          <div className="grid grid-cols-2 items-center px-5 gap-5 bg-gray-50 py-3 mb-3">
            ...
            <h3>{chapter.description || "No description"}</h3>
          </div>
          <div className="grid grid-cols-2 items-center px-5 gap-5 bg-gray-50 py-3 mb-3">
            <h3 className="text-gray-400">
              Have you completed the female And more Self-esteem module before?
              If yes, mention the year and module name:
            </h3>
            <h3>{chapter.famCompleted}</h3>
          </div>
          <div className="grid grid-cols-2 items-center px-5 gap-5 bg-gray-50 py-3 mb-3">
            <h3 className="text-gray-400">
              Have you coordinated, worked with or mentored females before? If
              yes, share a brief detail below:
            </h3>
          ...
          <div className="grid grid-cols-2 items-center px-5 gap-5 bg-gray-50 py-3 mb-3">
            <h3 className="text-gray-400">
              Are you committed to supporting females build Self-esteem, develop
              their potentials and reach for the highest levels in life?
            </h3>
          ...
          <div className="grid grid-cols-2 items-center px-5 gap-5 bg-gray-50 py-3 mb-3">
            <h3 className="text-gray-400">
              Are you sure you can meet the requirement of getting approved and
              accredited within 3 months’ time frame?:
            </h3>
