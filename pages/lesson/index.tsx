...
const Lesson = ({ data }: any) => {
	...
	return (
		<div className={"flex flex-col h-screen"}>
			<Head />
			<Navbar />
			{iDelete && <Delete deleteFunc={deleteLesson} setIDelete={setIDelete} message="Delete lesson" />}
			{editLesson && (
				<EditLesson
					lessons={lessons}
			...
			{createLesson && <CreateLesson lessons={lessons} setLessons={setLessons} setCreateLesson={setCreateLesson} />}
			<Dashboard>
				<div className="mx-auto container px-5 duration-300">
					<div className={"my-16"}>
						...
						<div style={{ color: "#B569D4" }} className={"flex items-center"}>
							<h5 className={"mr-2"}>Dashboard</h5> &gt; <h5 className={"ml-2"}>Lesson Bank</h5>
						</div>
					</div>
					<div>
						<Table
