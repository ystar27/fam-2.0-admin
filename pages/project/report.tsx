...
import { deleteProjectReport, getProjectReport } from "../../services/projectRequest";
...
function Idea() {
	...
	return (
		<div className={"flex flex-col h-screen"}>
			<Head />
			<Navbar />
			{details && <ProjectReportDetails activeProject={activeProject} setDetails={setDetails} />}
			{iDelete && <Delete deleteFunc={deleteIProject} setIDelete={setIDelete} message="Delete project report" />}
			<Dashboard>
				<div className="mx-auto container px-5 duration-300">
					<div className={"my-16"}>
						...
						<div style={{ color: "#B569D4" }} className={"flex items-center"}>
							<h5 className={"mr-2"}>Dashboard</h5> &gt; <h5 className={"ml-2"}> Project</h5>
						</div>
					</div>
					<div>
